...
func (FakeMongoClient) Connect(ctx context.Context, opts ...*options.ClientOptions) (*mongo.Client, error) {
	return &mongo.Client
}

// MongoClient returns a connection to an instance of Mongo
func (RealMongoClient *RealMongoClient) MongoClient() *mongo.Client {
