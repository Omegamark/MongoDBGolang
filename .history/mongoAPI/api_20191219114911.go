...
// UpdateGamer allows the gamers name and age to be changed.
func UpdateGamer(databaseName string, collectionName string) {
	client := MongoClient().Database(databaseName).Collection(collectionName)
