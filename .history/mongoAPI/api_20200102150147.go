...
func FindOneInCollection(collectionName collectionhelper.ICollectionHelper, gamerName interface{}, projections []interface{}) (models.Gamer, error) {
	// var mc RealMongoClient
	collection := coll.Collection(collectionName)
