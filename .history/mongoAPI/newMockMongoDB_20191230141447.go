...
func (dd DummyData) Collection(name string) (*ICollectionHelper.Collection, error) {
	return &ICollectionHelper.Collection{}, nil
}
...
func (rd RealData) Collection(name string) (*ICollectionHelper.Collection, error) {
	return &ICollectionHelper.Collection{}, nil
}
